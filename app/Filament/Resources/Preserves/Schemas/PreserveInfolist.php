...
class PreserveInfolist
{
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                Schemas\Components\Section::make(Common::sectionTitle('基础信息'))
                    ->schema([
                ...
                Schemas\Components\Section::make(function (Model $record) {
                    return Common::sectionTitle('保存信息: '.$record->preserve_type?->getLabel());
                })
                    ->schema([
                        // 种质圃保存
                        Schemas\Components\Grid::make([
